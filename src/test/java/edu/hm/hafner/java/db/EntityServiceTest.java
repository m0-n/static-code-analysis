...
class EntityServiceTest {
    ...
    void shouldThrowException() {
        IssueRepository issueRepository = mock(IssueRepository.class);
        IssuesRepository issuesRepository = mock(IssuesRepository.class);
        LineRangeRepository lineRangeRepository = mock(LineRangeRepository.class);
        EntityMapper entityMapper = mock(EntityMapper.class);
        EntityManager entityManager = mock(EntityManager.class);
        EntityService entityService = new EntityService(issueRepository, issuesRepository, lineRangeRepository, entityMapper, entityManager);
        assertThatThrownBy(() -> new EntityService(null, null, null, null, null)).isInstanceOf(NullPointerException.class);
        assertThatThrownBy(() -> entityService.insert((Issue) null)).isInstanceOf(NullPointerException.class);
        assertThatThrownBy(() -> entityService.insert((Issues) null)).isInstanceOf(NullPointerException.class);
        assertThatThrownBy(() -> entityService.select(null)).isInstanceOf(NullPointerException.class);
        assertThatThrownBy(() -> entityService.select(null, null)).isInstanceOf(NullPointerException.class);
        assertThatThrownBy(() -> entityService.selectByReference(null)).isInstanceOf(NullPointerException.class);
        assertThatThrownBy(() -> entityService.selectByOrigin(null)).isInstanceOf(NullPointerException.class);
        assertThatThrownBy(() -> entityService.update((Issue)null)).isInstanceOf(NullPointerException.class);
        assertThatThrownBy(() -> entityService.update((Issues)null)).isInstanceOf(NullPointerException.class);
    }
}
