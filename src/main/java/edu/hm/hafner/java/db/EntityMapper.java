...
public class EntityMapper {
    ...
    /**
     * Map the issues to to the entity object. This is used to update existing entities in the database.
     * @author Lukas Gollwitzer
     * @param issues map to a entity
